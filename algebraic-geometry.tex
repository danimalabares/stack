...
\label{section-bezout-theorem}

\noindent
The upshot is that the ``size'' of the intersection
...
has to be made precise, which is via the notion of multiplicity.
...
\section{Multiplicities of points and singularities}
