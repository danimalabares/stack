...
bundle of $C$ with $h^1(T_C)$. A natural guess is that
$(\mathcal{O}(C),\mathcal{O}(C))=2h^1(T_C)$, but that's totally a guess.

Now remember \cite[p. 146]{gri} Adjunction formula I that the normal bundle
$\mathcal{N}$ of a hypersurface 
...
$$
\xymatrix{
0\ar[r]&T_C\ar[r]&T_X|_{C}\ar[r]&\mathcal{N}\ar[r]&0
}
$$
