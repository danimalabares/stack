...
$V(I)$ and lots of properties, Nullstellensatz and
...
\section{Dimension: Krull dimension, transcendence degree, tangent space}
\label{section-dimension}

\noindent
See \href{https://www.youtube.com/live/naaJ-mUfE_k?si=FA1o9Va3oRcCXTRY&t=2001}{
here} for Olivier's definition of Krull dimension.


\section{Multiplicities, smooth points and Bézout's theorem}
...
\section{Jacobian criterion}
\label{section-jacobian-criterion}
...
\section{Plücker formulas}
\label{section-plucker-formulas}
...
are $\delta$ nodes and $\chi$ ordinary cursps
