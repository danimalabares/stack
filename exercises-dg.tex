...
Portanto, $\gamma$ não tem pontos conjugados entre $p$ e $q$. Idea: isso vai
 obrigar a que a geodésica seja minimizante antes de $q$: suponha que
$\gamma$ não é minimizante
$$
d(p,C_m(p))=d(p,q)=\text{inf}_{}
$$
