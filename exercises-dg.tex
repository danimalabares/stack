...
Suponha que $M$ é completa, de modo que podemos garantir a existência de
...
Então podemos aplicar a Proposição \ref{proposition-cut-point-characterization}:
 um ponto $q$ é o cut point de $p$ ao longo de $\gamma$ se e somente se
...
Se (a) é verdadeira, terminamos. Se (b) é verdadiera, considere a variação por geodésicas 
$$
