...
Finalmente usei a prova de \cite{doc}: seja $c$ alguma das curvas da
variação que vem do Exercício 6 da Lista 6, com comprimento estritamente
...
$\tilde{p}_s$ e $\tilde{\sigma}_s$ ressaltando o parâmetro da variação $s$.
...
compacidade do fibrado unitário. Note que por continuidade da função distância,
a geodésica obtida minimiza a distância entre $p$ e $q$, por um lado porque o
limite dos pontos iniciais e $p$ por definição, e por outro lado porque os
...
campo variacional no ponto final seja $\gamma'(q)$ e fixando o ponto inicial.
...
Tal variação é dada pegando pontos arbitrariamente perto de $\tilde{q}$ ao
longo de cada $\tilde{\gamma}_s$.
\end{proof}
