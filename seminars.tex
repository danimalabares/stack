...
\medskip\noindent
Upshot: how to differentiate Lie 2-groupoids?
This means, having a Lie 2-groupoid, we want
to have an infinitesimal counterpart
(as Lie algebras are to Lie groups).
...
$$
\xymatrix{
\cdots & M\times M \times M \ar[r]^{triple}& M \times M \ar[r]^{double}& M.
}
$$
...
$$
There's the following ecosistem around Lie groupoids:
$$
\xymatrix{
&\text{Lie groupoids}
