...
\begin{proof} The fact that it is prime comes from the fact that $X$ is
irreducible. Now suppose that $0 \subset \mathfrak{p} \subset I$ with strict
contentions. Then $V(\mathfrak{p})$ is an analytic variety that contains $X$.
At regular points, $X$ is a smooth manifold of codimension 1, so that there
cannot be an intermediate manifold between $X$ and the ambient manifold $M$.
