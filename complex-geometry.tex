...
\section{p,q decomposition}
\label{section-pq-decomposition}
...
\begin{reference}
\cite[Definition 3.1.1]{huc}
\end{reference}
A {\it hermitian structure} on a complex manifold $X$ 
is a Riemannian metric $g$ on $X$ which is an isometry
for the complex structure.
\end{definition}

\begin{definition}
\label{definition-kahler-structure}
\begin{reference}
\cite[Definition 3.1.6.]{huc}
\end{reference}
A {\it Kähler structure} is an hermitian structure $g$ 
for which the fundamental form is closed.
\end{definition}

\noindent
*Examples of Kähler forms*
