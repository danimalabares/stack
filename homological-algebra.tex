...
\begin{proposition}
\label{proposition-g-mod-abelian-category}
...
We say Equation \ref{equation-ses-gmod}
...
\noindent
Note: if Equation \ref{equation-ses-gmod}
...
\begin{definition}
\label{definition-lie-algebra-cohomology}
