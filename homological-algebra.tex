...
\section{AI: background for September 4}
\label{section-ai-background-sept-four}

\noindent
\textbf{AI-written material begins here.}
The preceding notes are restored verbatim
from the version before the September 4
additions. All sections below are
AI-written additions, separate from
Daniel's original notes.
...
\label{example-ai-cyclic-sept-four}
...
\section{AI: September 4 --- Hilbert 90}
...
\ref{example-ai-cyclic-sept-four}
