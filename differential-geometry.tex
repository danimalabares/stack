...
If $q \in M\setminus C_m(p)$, there exists a unique minimizing geodesic joining
$p$ and $q$.
\end{lemma}

\begin{proof}
This is an immediate consequence of Proposition 
\ref{proposition-cut-point-characterization}: first, by Hopf-Rinow, we know that
there exists a minimizing geodesic joining any two points. We know by Exercise  
\ref{exercise-curvas-minimizantes} that if there were two minimizing geodesics 
