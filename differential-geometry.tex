...
\mathfrak{X}_{\gamma|_{[t_j,t_{j+1}]}}^J\}=\bigoplus_{j=1}^{i-1}T_{\gamma(t_j)}M
\end{align*}
Onde a igualdade em $\mathcal{V}_t^-$ é porque para qualquer escolha de vetores
